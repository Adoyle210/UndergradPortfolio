...
// PHOTO ENDPOINTS:
//GET /photos" Get list of all photos
...
//POST /photos{userid, businessid}: upload a photo for an exisitng business
...
//PUT /photos{userid, businessid}: Update photo
...
//DELETE /photos{userid, businessid}: Delete photo
...
// REVIEWS ENDPOINTS:
// GET /reviews: Get list of all reviews
app.get("/reviews", function (req, res, next) {
  ...
  //POST /reviews: Write a review for an existing business
...
//PUT /reviews/{userid, businessid}: Update an existing reviews
...
//DELETE /reviews/{userid, businessid}: Delete an existing reviews
...
// USERS ENDPOINTS:
//GET /businesses/user{ownerid}: List all user's businesses
...
//GET /reviews/users{userid}: List all user's reviews
...
//GET /photos/users{userid}: List all user's photos
...
//catch-all to respond with a 404 (not found) 
